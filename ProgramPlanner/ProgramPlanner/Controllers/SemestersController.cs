...
namespace ProgramPlanner.Controllers
{
    public class SemestersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SemesterID,SemesterValue")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SemesterID,SemesterValue")] Semester semester)
        {
            if (ModelState.IsValid)
            {
